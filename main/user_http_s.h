...
/* 获取天气预报的地址 */
#define HTTPS_URL_BJ            "https://api.seniverse.com/v3/weather/daily.json?key=4nik0ivxfmxfjzz1&location=ip&language=zh-Hans&unit=c&start=0&days=5"
#define LUNA_URL                "https://api.seniverse.com/v3/life/chinese_calendar.json?key=4nik0ivxfmxfjzz1&start=0&days=1"
