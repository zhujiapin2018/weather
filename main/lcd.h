...
//extern uint16_t SPI_LCD_RAM[320*240];//缓存大小
 extern const uint8_t hzks_fon_start[] asm("_binary_hzk32s_fon_start");
 extern const uint8_t hzks_fon_end[] asm("_binary_hzk32s_fon_end");
 //extern const uint8_t asc_fon_start[] asm("_binary_asc_fon_start");
 //extern const uint8_t asc_fon_end[] asm("_binary_asc_fon_end");
//LCD重要参数集
typedef struct  
{										    
